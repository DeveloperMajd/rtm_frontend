...
const GroupSettingsPanel = ({ open, conversation, currentUserId, onClose }: GroupSettingsPanelProps) => {
  ...
  const [confirmingSoloLeave, setConfirmingSoloLeave] = useState(false)
  ...
  return (
    <>
      ...
      <ConfirmDialog
        open={open && confirmingSoloLeave}
        title='Leave group?'
        message="You're the only member left in this group. If you leave, you won't be able to rejoin — there's no one left who could add you back."
        confirmLabel='Leave anyway'
        loading={isLeaving}
        onConfirm={() => leave()}
        onCancel={() => setConfirmingSoloLeave(false)}
      />

      <ConfirmDialog
        open={confirmingDelete}
        title='Delete group?'
        message="This deletes the group for everyone, not just you. This can't be undone."
        confirmLabel='Delete'
        loading={isDeleting}
